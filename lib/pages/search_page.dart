...
class _SearchPageState extends State<SearchPage> {
  ...
  getCurrentUserIdandName() async {
    await HelperFuntion.getUserNameFromSF().then((value) {
      setState(() {
        userName = value!;
      });
    });
  ...
  Widget groupTile(
    ...
    //function to check whether the user already exisits in group
