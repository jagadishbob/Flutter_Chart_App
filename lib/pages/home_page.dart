...
import 'package:swift_chat/pages/profile_page.dart';
import 'package:swift_chat/pages/search_page.dart';
import 'package:swift_chat/service/auth_service.dart';
import 'package:swift_chat/service/database_services.dart';
import 'package:swift_chat/widgets/group_tile.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  gettingUserData() async {
    await HelperFuntion.getUserEmailFromSF().then((value) {
      setState(() {
        email = value!;
      });
    });
    await HelperFuntion.getUserNameFromSF().then((val) {
      setState(() {
        userName = val!;
      });
    });
